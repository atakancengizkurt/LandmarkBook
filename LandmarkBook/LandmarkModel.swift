...
let coloseumLandmark = Landmark(id: 1, name: "Coloseum", imageName: "colosseum", country: "Italy", category: "Historic Area", coordinates: Coordinates(latitude: 41.8902102, longitude: 12.490422))
...
let sydneyLandmark = Landmark(id: 4, name: "Sydney Opera House", imageName: "sydney", country: "Australia", category: "Opera Hause", coordinates: Coordinates(latitude: -33.8567844, longitude: 151.213108))

let landmarkArray = [eiffelLandmark,coloseumLandmark,londonBridgeLandmark,pisaLandmark,sydneyLandmark]
